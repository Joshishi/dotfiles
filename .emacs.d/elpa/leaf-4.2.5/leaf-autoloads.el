...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "cort-test" '("cort-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "leaf-tests" '("cort-deftest-with-")))
